...
// 회원 가입, 회원 정보 수정시 암호 확인 및 데이터 입력을 체크
...
function idCheck() {
	...
	window.open(url,"_blank_1","toolbar=no, menubar=no, scrollbar=yes, width=450,height=200");
